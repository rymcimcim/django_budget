...
dump-primary :
	venv/bin/python manage.py dumpdata --format=json --database=primary --verbosity=1 --output=budgets/fixtures/budgets.json

dump-replica :
	venv/bin/python manage.py dumpdata --format=json --database=replica --verbosity=1 --output=budgets/fixtures/budgets.json

populate-primary :
	venv/bin/python manage.py loaddata budgets.json --database=primary 

populate-replica :
	venv/bin/python manage.py loaddata budgets.json --database=replica
...
migrations :
	venv/bin/python manage.py makemigrations budgets
